...
public class App extends Application {
	...
	public static boolean isLogin(){
		int uId = pre.getInt(Global.UID, -1);
		if(uId == -1){
			return false;
		}
		return true;
...
//		return contactList;
	...
	public static String getCommonParams(){
		return "u_id="+App.pre.getInt(Global.UID, -1)
				+"&u_divice_id="+AppInfoUtil.getDeviceId(applicationContext)
				+"&u_token="+pre.getString(Global.TOKEN, "");
	}
